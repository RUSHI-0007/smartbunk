...
export const StudentLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 relative selection:bg-primary selection:text-white">
      <Sidebar />
      {/* 
      ...
      */}
      <main className="flex-1 lg:ml-[18rem] bg-[#fdfdfd] min-h-screen shadow-inner border-l border-white relative z-0">
